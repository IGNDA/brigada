...
export const faqData: FAQItem[] = [
  ...
  {
    question: "O que fazer ao encontrar um enxame de abelhas?",
    answer:
      "Mantenha a calma, não jogue água, fumaça ou tente remover o enxame. Afaste pessoas e animais do local e entre em contato conosco. Realizamos a retirada segura, preservando as abelhas e a segurança de todos.",
  },
  {
    question: "Por que as abelhas são importantes para o meio ambiente?",
    answer:
      "As abelhas são os principais polinizadores da natureza. Sem elas, a reprodução de muitas plantas, incluindo culturas agrícolas, seria comprometida. A preservação dos polinizadores é essencial para a biodiversidade e a segurança alimentar.",
  },
  {
    question: "Como prevenir incêndios florestais?",
    answer:
      "Não faça fogueiras em áreas de vegetação seca, não jogue bitucas de cigarro em matas, não solte balões, denuncie queimadas irregulares e apoie ações de conscientização. A prevenção é a forma mais eficaz de proteger nossas florestas.",
  },
  {
    question: "Qual é a importância da preservação da Mata Atlântica?",
    answer:
