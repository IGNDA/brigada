...
export default function FloatingWhatsApp() {
  return (
    ...
    >
      <div className="flex items-center gap-3 bg-white rounded-full shadow-xl p-2 sm:pr-5 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 border border-forest-100">
        <button
